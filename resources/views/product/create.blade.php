            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class="w-100">
                        {{ html()->form('POST', '/product/store')->acceptsFiles()->open() }}
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-12 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('category_id_fk', $category_data)->class('form-control text-light')->placeholder('Select category') }}
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('subcat_id_fk', $subCat_data)->class('form-control text-light')->placeholder('Select Sub category') }}
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->text('sku')->class('form-control text-light')->placeholder('Enter Stock-keeping unit') }}
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->number('buying_price')->class('form-control text-light')->placeholder('Enter buying price') }}
                                        @if ($errors->has('buying_price'))
                                            <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('buying_price') }}</strong>
                                            </span>
                                        @endif
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->number('selling_price')->class('form-control text-light')->placeholder('Enter selling price') }}
                                        @if ($errors->has('selling_price'))
                                            <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('selling_price') }}</strong>
                                            </span>
                                        @endif
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->text('brand')->class('form-control text-light')->placeholder('Enter brand') }}
                                        @if ($errors->has('brand'))
                                            <span class="help-block">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('tax')->options(['' => 'Select', '1' => 'No -VAT', '2' => 'VAT -5', '3' => 'VAT-10', '4' => 'VAT-20'])->class('form-control text-light') }}
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mt-2">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('status')->options(['' => 'Select status', '1' => 'Active', '0' => 'Inactive'])->class('form-control text-light') }}
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mt-2">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('purchasable')->options(['' => 'select', '1' => 'Yes', '0' => 'No'])->class('form-control text-light') }}
                                        @if ($errors->has('purchasable'))
                                            <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('purchasable') }}</strong>
                                            </span>
                                        @endif
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mt-2">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('stock_out')->options(['' => 'Select', '1' => 'Enable', '0' => 'Disable'])->class('form-control text-light') }}
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mt-2">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('refundable')->options(['' => 'Select', '1' => 'Yes', '0' => 'No'])->class('form-control text-light') }}
                                        @if ($errors->has('refundable'))
                                            <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('refundable') }}</strong>
                                            </span>
                                        @endif
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->number('max_quantity')->class('form-control text-light')->placeholder('Enter max quantity') }}
                                        @if ($errors->has('max_quantity'))
                                            <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('max_quantity') }}</strong>
                                            </span>
                                        @endif
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4  mt-2 ">
                                    <fieldset class="form-group">
                                        <label for="name">Low Stock Quantity Warning <span
                                                class="text-danger">*</span></label>
                                        {{ html()->number('min_quantity')->class('form-control text-light')->placeholder('Enter low stock quantity') }}
                                        @if ($errors->has('min_quantity'))
                                            <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('min_quantity') }}</strong>
                                            </span>
                                        @endif
                                    </fieldset>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mt-2">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->select('unit')->options(['' => 'Select', '1' => 'Piece (pc)', '2' => 'Gram (gm)', '3' => 'Liter (lt)'])->class('form-control text-light') }}
                                        @if ($errors->has('unit'))
                                            <span class="help-block">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 mb-4 mt-2">
                                    <fieldset class="form-group">
                                        ...
                                        {{ html()->text('weight')->class('form-control text-light') }}
