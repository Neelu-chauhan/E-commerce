<div class="hero_area">
    ...
    <header class="header_section">
        <div class="container">
            <nav class="navbar navbar-expand-lg custom_nav-container ">
                <a class="navbar-brand" href="index.html"><img width="200px" height="="
                        src="{{ url('frontend/assets/images/logoo.png') }}" class="align-left" alt="#" /></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <svg version="1.1" id="Capa_1"
                                    xmlns="{{ url('frontend/assets/http://www.w3.org/2000/svg') }}"
                                    xmlns:xlink="{{ url('frontend/assets/http://www.w3.org/1999/xlink') }}" x="0px" y="0px"
    ...
    {{-- <section class="slider_section ">
        <div class="slider_bg_box">
            <img src="{{ url('assets/images/slider-bg.jpg') }}" alt="">
        </div>
